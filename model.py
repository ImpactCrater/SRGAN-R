...
def SRGAN_g(t_image, is_train=False, reuse=False):
    ...
    with tf.variable_scope("SRGAN_g", reuse=reuse) as vs:
        ...
        for i in range(8):
            ...
            n1_0 = Conv2d(n0_1, df_dim, (1, 1), (1, 1), act=swish, padding='SAME', W_init=w_init, b_init=b_init, name='res_c1/%s' % i)
            n1_1 = Conv2d(n1_0, df_dim, (3, 3), (1, 1), act=swish, padding='SAME', W_init=w_init, b_init=b_init, name='res_c2/%s' % i)
            n1_2 = ConcatLayer([n, n0_0, n1_1],concat_dim=-1, name='res_concat1/%s' % i)

            n2_0 = Conv2d(n1_2, df_dim, (1, 1), (1, 1), act=swish, padding='SAME', W_init=w_init, b_init=b_init, name='res_c3/%s' % i)
            n2_1 = Conv2d(n2_0, df_dim, (3, 3), (1, 1), act=swish, padding='SAME', W_init=w_init, b_init=b_init, name='res_c4/%s' % i)
            n2_2 = ConcatLayer([n, n0_0, n1_1, n2_1], concat_dim=-1, name='res_concat2/%s' % i)

            n3_0 = Conv2d(n2_2, df_dim, (1, 1), (1, 1), act=swish, padding='SAME', W_init=w_init, b_init=b_init, name='res_c5/%s' % i)
            n3_1 = Conv2d(n3_0, df_dim, (3, 3), (1, 1), act=swish, padding='SAME', W_init=w_init, b_init=b_init, name='res_c6/%s' % i)
            n3_2 = ConcatLayer([n, n0_0, n1_1, n2_1, n3_1], concat_dim=-1, name='res_concat3/%s' % i)

            n4_0 = Conv2d(n3_2, df_dim, (1, 1), (1, 1), act=swish, padding='SAME', W_init=w_init, b_init=b_init, name='res_c7/%s' % i)
            n4_1 = Conv2d(n4_0, df_dim, (3, 3), (1, 1), act=swish, padding='SAME', W_init=w_init, b_init=b_init, name='res_c8/%s' % i)
            n4_2 = ElementwiseLayer([n, n4_1], tf.add, name='res_add0/%s' % i)
            n = n4_2

        n = Conv2d(n, df_dim, (3, 3), (1, 1), act=swish, padding='SAME', W_init=w_init, b_init=b_init, name='res_c9')
